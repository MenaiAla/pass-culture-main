...
def compute_booking_cancellation_limit_date(
    ...
    tz_naive_event_beginning = date_utils.datetime_to_timezone_naive_datetime(event_beginning)
    before_event_cancellation_date = tz_naive_event_beginning - constants.CONFIRM_BOOKING_BEFORE_EVENT_DELAY
...
def _compute_edition_cancellation_limit_date(
    ...
    return min(tz_naive_event_beginning, after_edition_cancellation_date)
