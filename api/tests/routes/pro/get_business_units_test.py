...
def test_get_business_units_by_pro(client):
    ...
    offerers_factories.UserOffererFactory(user=pro, offerer=venue1.managingOfferer)
...
def test_get_business_units_by_pro_filtered_on_offerer_id(client):
    ...
    pro = users_factories.ProFactory()
    offerers_factories.UserOffererFactory(user=pro, offerer=venue1.managingOfferer)
    offerers_factories.UserOffererFactory(user=pro, offerer=venue2.managingOfferer)
